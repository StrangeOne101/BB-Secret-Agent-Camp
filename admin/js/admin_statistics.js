google.charts.setOnLoadCallback(function() {
	...
	query = "SELECT tbl_companies.CompanyName, COUNT(tbl_signups_19.CompanyUnit) FROM `tbl_signups_19` INNER JOIN tbl_companies ON tbl_signups_19.CompanyUnit = tbl_companies.CompanyID WHERE tbl_signups_19.RegisteeType >= 2 AND tbl_signups_19.RegisteeType <= 3 GROUP BY CompanyName";
