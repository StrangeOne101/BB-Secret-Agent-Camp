...
function getRegistrationQuery() {
    ...
    return "SELECT $TABLE_REGISTRATIONS.ID, $TABLE_REGISTRATIONS.FirstName, $TABLE_REGISTRATIONS.LastName, $TABLE_COMPANIES.CompanyName AS Company, " .
		...
		"$TABLE_REGISTRATIONS.FoodDetails, $TABLE_REGISTRATIONS.CadetID, $TABLE_REGISTRATIONS.DateRegistered, $TABLE_REGISTRATIONS.RefNo, IF($TABLE_REGISTRATIONS.PhotoPerm=1,'Yes','No') AS PhotoPerm " .
